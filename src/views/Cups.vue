  ...
  <div class="container">
    ...
    <div id="u11">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
        <tr v-for="club in cupEntries['Under11']"  v-bind:key="club">
          <td>{{club.clubName}}</td>
        </tr></tbody>
      </table>
    </div>
    ...
    <div id="u12">
      ...
      <table class="table table-bordered">
        <thead><tr><th>Club</th></tr></thead>
        <tbody>
        <tr v-for="club in cupEntries['Under12']"  v-bind:key="club">
          <td>{{club.clubName}}</td>
        </tr></tbody>
      </table>
    </div>
    ...
    <div id="u14">
      ...
      <table class="table table-bordered">
        <thead><tr><th>Club</th></tr></thead>
        <tbody>
        <tr v-for="club in cupEntries['Under14']"  v-bind:key="club">
          <td>{{club.clubName}}</td>
        </tr></tbody>
      </table>
    </div>
