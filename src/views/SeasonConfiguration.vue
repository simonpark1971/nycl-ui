  ...
  <div class="container">
    ...
    <div v-if="currentSeason" class="panel panel-default">
      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="ageGroupConfig in currentSeason.config.ageGroupConfigurations" v-bind:key="ageGroupConfig">
            ...
            <td>
              <div v-for="division in ageGroupConfig.divisions" v-bind:key="division">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      update: function () {
        axios.put('saveseason', this.currentSeason)
      }
    },
    mounted () {
      var self = this
